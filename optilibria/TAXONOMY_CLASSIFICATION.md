...
This document provides a comprehensive taxonomy of optimization methods in Optilibria, classifying them by type, applicability, and performance characteristics.
...
**Implementation:** `optilibria.methods.baselines.random_search`
...
**Implementation:** `optilibria.methods.baselines.simulated_annealing`
...
**Implementation:** `optilibria.methods.baselines.local_search`
...
**Implementation:** `optilibria.methods.baselines.genetic_algorithm`
...
**Implementation:** `optilibria.methods.baselines.tabu_search`
...
**Implementation:** `optilibria.methods.novel.fft_laplace` (raises NotImplementedError)
...
```python
    ...
    from optilibria.methods.category.new_method import new_method_optimize
...
Optilibria provides a well-rounded set of 5 baseline methods covering major optimization paradigms:
...
**Maintainer:** Optilibria Development Team
