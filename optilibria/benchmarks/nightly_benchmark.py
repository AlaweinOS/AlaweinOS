#!/usr/bin/env python3
"""
Nightly Benchmark Runner for Optilibria
...
from optilibria.benchmarks.qaplib import load_qaplib_instance, list_qaplib_instances
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Optilibria Nightly Benchmark Runner"
    )
    parser.add_argument(
        '--suite',
