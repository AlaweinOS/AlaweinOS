#!/usr/bin/env python3
"""
Report Generation for Optilibria Benchmarks
...
<head>
    ...
    <title>Optilibria Benchmark Report - {suite_name}</title>
...
<body>
    <div class="container">
        <header>
            <h1>🏆 Optilibria Benchmark Report</h1>
        ...
        <footer>
            <p>Generated by Optilibria Benchmark System | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
        </footer>
    </div>
...
class MarkdownReportGenerator:
    ...
    def generate(self, results: Dict, output_path: Path):
        ...
        md_content = f"""# Optilibria Benchmark Report
