# Optilibria Benchmarking System

## Overview

The Optilibria benchmarking system provides comprehensive performance testing and tracking for all optimization algorithms. It includes automated nightly benchmarks, performance regression detection, and detailed reporting.
...
The GitHub Actions workflow (`optilibria-nightly-benchmark.yml`) provides:
...
1. Go to Actions tab
2. Select "Optilibria Nightly Benchmark"
...
1. **Import Errors**: Ensure optilibria is installed: `pip install -e .`
