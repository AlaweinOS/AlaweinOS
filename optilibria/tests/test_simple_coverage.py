...
def test_optilibria_main():
    """Test main optilibria module."""
    import optilibria
    ...
    result = optilibria.optimize(problem, max_iterations=10)
    assert result is not None
    assert 'solution' in result

    # Test StandardizedProblem
    std_problem = optilibria.StandardizedProblem(
        dimension=5,
    ...
    std_solution = optilibria.StandardizedSolution(
...
def test_qaplib_benchmark():
    ...
    from optilibria.benchmarks import qaplib
...
def test_ai_module():
    ...
    from optilibria.ai import AIMethodSelector
    from optilibria.ai.features import FeatureExtractor
...
def test_benchmarking_module():
    ...
    from optilibria.benchmarking import benchmark
...
def test_quantum_modules():
    ...
    from optilibria.quantum.validators import ProblemValidator, QubitEstimator
...
def test_adapters_module():
    ...
    from optilibria.adapters import qap, tsp
...
def test_core_module():
    ...
    from optilibria.core import interfaces
