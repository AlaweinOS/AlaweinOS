...
from optilibria.ai.features import FeatureExtractor, ProblemFeatures
from optilibria.ai.method_selector import MethodRecommendation
...
class TestAIMethodSelector:
    ...
    @patch('optilibria.ai.method_selector.redis')
