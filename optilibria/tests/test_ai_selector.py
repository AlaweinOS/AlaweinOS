...
from optilibria.ai.features import ProblemFeatureExtractor, ProblemFeatures
from optilibria.ai.method_selector import MethodRecommendation, MethodSelector, PerformanceRecord
from optilibria.ai.models import DataCollector, MethodSelectorModel
...
class TestIntegration:
    ...
    def test_optimize_auto_fallback(self):
        ...
        with patch('optilibria.ai.MethodSelector', side_effect=Exception("Test error")):
            result = optimize(
                problem=problem,
                method='auto'
            )
