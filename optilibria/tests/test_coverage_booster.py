...
def test_main_imports():
    ...
    from optilibria import StandardizedProblem, StandardizedSolution
...
def test_utils_matrix_ops():
    ...
    from optilibria.utils import matrix_ops
...
def test_utils_validation():
    ...
    from optilibria.utils import validation
...
def test_benchmarking_components():
    ...
    from optilibria.benchmarking import benchmark, metrics
...
def test_ai_components():
    ...
    from optilibria.ai import features, models
...
def test_quantum_validators():
    ...
    from optilibria.quantum.validators import problem_validator, qubit_estimator
...
def test_quantum_utils():
    ...
    from optilibria.quantum.utils import (
        hamiltonian_builder,
        result_converter,
        state_decoder
    )
...
def test_main_api_functions():
    ...
    assert hasattr(optilibria, '__version__')
