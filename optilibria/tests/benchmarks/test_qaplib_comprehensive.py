...
from optilibria.benchmarks.qaplib.embedded_data import EMBEDDED_QAPLIB_DATA as EMBEDDED_INSTANCES
...
class TestQAPLIBBenchmarkRunner:
    ...
    def runner(self):
        ...
        from optilibria.methods.baselines import RandomSearchOptimizer
    ...
    @patch('optilibria.benchmarks.qaplib.benchmark_runner.QAPLIBLoader')
