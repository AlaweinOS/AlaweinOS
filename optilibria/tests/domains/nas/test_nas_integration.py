...
from optilibria.domains.nas.architecture import Operation, OperationType
from optilibria.domains.nas.zero_cost_proxies import (
...
class TestNASIntegration:
    ...
    def test_macro_architecture_creation(self):
        ...
        from optilibria.domains.nas.architecture import Layer
    ...
    def test_nas_adapter(self):
        """Test NAS adapter for Optilibria integration."""
        problem = NASProblem(
            dataset='cifar10',
            search_space='cell',
            objectives=['accuracy']
