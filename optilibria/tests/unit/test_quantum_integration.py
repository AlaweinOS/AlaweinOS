...
class TestIsingEncoding:
    ...
    def test_ising_encoder_import(self):
        ...
        from optilibria.quantum.adapters import IsingEncoder
    ...
    def test_qubo_to_ising(self):
        ...
        # Create simple QUBO
        Q = np.array([[1, 2], [2, 3]])
        from optilibria.quantum.adapters.qubo_converter import QUBOProblem
...
class TestQuantumUtilities:
    ...
    def test_state_decoder_import(self):
        ...
        from optilibria.quantum.utils import QuantumStateDecoder
    ...
    def test_hamiltonian_builder_import(self):
        ...
        from optilibria.quantum.utils import HamiltonianBuilder
    ...
    def test_result_converter_import(self):
        ...
        from optilibria.quantum.utils import quantum_to_classical_result
...
class TestQuantumMethods:
    ...
    def test_method_imports(self):
        ...
        from optilibria.quantum.methods import (
