...
from optilibria.validation.test_problems import (
...
from optilibria.validation.validator import (
    OptimizationValidator, ValidationResult
)
from optilibria.validation.continuous_validation import ContinuousValidator
...
class TestValidator:
    ...
    @pytest.mark.skipif(
        True,  # Skip by default as it requires full optilibria installation
        reason="Requires full optilibria optimization module"
    )
    def test_validate_method(self):
        """Test method validation (requires full optilibria)."""
