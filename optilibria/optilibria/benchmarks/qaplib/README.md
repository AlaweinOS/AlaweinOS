...
- **Easy Integration**: Works seamlessly with Optilibria optimization methods

## Quick Start

```python
from optilibria.benchmarks.qaplib import load_qaplib_instance, run_qaplib_benchmark
...
See `/home/user/AlaweinOS/optilibria/examples/qaplib_benchmark_example.py` for comprehensive examples.
