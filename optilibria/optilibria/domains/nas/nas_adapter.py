"""NAS adapter for Optilibria optimization framework.

This module provides the adapter that allows NAS problems to be solved
using Optilibria's optimization algorithms.
"""
...
class StandardizedProblem:
    """Standardized optimization problem format for Optilibria."""
...
class NASAdapter(DomainAdapter):
    ...
    by Optilibria's algorithms, handling:
