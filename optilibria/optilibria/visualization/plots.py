...
Note: matplotlib is an optional dependency, install with: pip install optilibria[viz]
"""
...
def _check_matplotlib() -> None:
    ...
    if not MATPLOTLIB_AVAILABLE:
        raise ImportError(
            ...
            "Install with: pip install optilibria[viz] or pip install matplotlib"
        )
...
def plot_benchmark_heatmap(
    ...
    Example:
        ...
        >>> from optilibria.visualization import plot_benchmark_heatmap
        >>>
        >>> problems = [
