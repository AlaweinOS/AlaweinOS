...
from optilibria.quantum import require_quantum_library
...
def _build_vqe_circuit_qiskit(ansatz, params, n_qubits):
    ...
    raise NotImplementedError(
        ...
        "Install qiskit with: pip install optilibria[quantum]"
    )
...
def _build_vqe_circuit_pennylane(ansatz, params, n_qubits):
    ...
    raise NotImplementedError(
        ...
        "Install pennylane with: pip install optilibria[quantum]"
    )
