...
and require installing with: pip install optilibria[quantum]
        ...
        def wrapper(*args, **kwargs):
            if not check_quantum_availability(library):
                ...
                raise ImportError(
                    ...
                    f"Please install with: pip install optilibria[quantum]"
                )
...
if QISKIT_AVAILABLE or PENNYLANE_AVAILABLE:
    ...
    def _quantum_not_available(*args, **kwargs):
        raise ImportError(
            ...
            "Install with: pip install optilibria[quantum]"
        )
