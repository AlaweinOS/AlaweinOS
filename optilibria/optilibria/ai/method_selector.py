...
from optilibria.core.interfaces import StandardizedProblem, UniversalOptimizationInterface
...
class MethodSelector:
    ...
    def _load_ml_model(self):
        ...
        # Would load from optilibria.ai.models
        try:
            from optilibria.ai.models import load_pretrained_selector
