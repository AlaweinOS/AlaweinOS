...
This document describes performance optimizations implemented in Optilibria and best practices for achieving optimal performance.

## Implemented Optimizations

### 1. TSP Distance Matrix Computation (10-100x speedup)

**Location:** `optilibria/adapters/tsp/__init__.py:_compute_distance_matrix()`
...
```python
from optilibria.benchmarking import compare_methods
...
from optilibria.parallel import ParallelOptimizer
...
```python
# Not yet implemented, but planned for v2.0
from optilibria.gpu import GPUOptimizer
...
```python
from optilibria.benchmarking import benchmark_method
...
```python
from optilibria.benchmarking import compare_methods
from optilibria.visualization import plot_method_comparison
...
```python
from optilibria.benchmarking import benchmark_suite
from optilibria.benchmarking.metrics import compute_performance_profile
from optilibria.visualization import plot_performance_profile
