# Optilibria Quick Start Guide

Get started with Optilibria in 5 minutes!

## Installation

```bash
# Clone and install
cd /path/to/AlaweinOS/optilibria
pip install -e .
```
...
3. **Explore adapters:** [QAP](../optilibria/adapters/qap/), [TSP](../optilibria/adapters/tsp/)
