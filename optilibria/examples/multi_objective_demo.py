...
# Import Optilibria multi-objective components
from optilibria.multi_objective import (
...
from optilibria.multi_objective.moead import DecompositionMethod
from optilibria.multi_objective.indicators import PerformanceMetrics

# Import constraint handling components
from optilibria.constraints import (
...
if __name__ == "__main__":
    print("=" * 60)
    print("Optilibria Multi-Objective Optimization Demo")
    print("=" * 60)
