#!/usr/bin/env python3
"""
Demonstration of Adaptive Learning System for Optilibria
...
from optilibria.adaptive.surrogate import SurrogateOptimizer, AcquisitionFunction
from optilibria.adaptive.performance_db import OptimizationRun
...
def main():
    ...
    print("\n" + "="*70)
    print(" OPTILIBRIA ADAPTIVE LEARNING SYSTEM DEMONSTRATION")
    print("="*70)
    ...
    print("="*70)
    print("\nThe Adaptive Learning System enables Optilibria to:")
