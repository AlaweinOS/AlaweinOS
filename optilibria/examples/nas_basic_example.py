#!/usr/bin/env python3
"""Basic example of using Neural Architecture Search with Optilibria.
...
import numpy as np
from optilibria.domains.nas import (
...
from optilibria.domains.nas.zero_cost_proxies import ProxyEnsemble
...
def example_nas_with_optilibria():
    """Example of using NAS with Optilibria's optimize function."""
    print("\n" + "="*60)
    print("NAS WITH OPTILIBRIA INTEGRATION")
    print("="*60)
