#!/usr/bin/env python3
"""
Warm-Starting Demonstration for Optilibria
...
from optilibria.warmstart import SolutionCache, SolutionTransformer, TransformMethod
...
def demonstrate_parameter_sweep():
    ...
    cache = SolutionCache(cache_dir=".optilibria_cache")
...
def main():
    ...
    print("WARM-STARTING DEMONSTRATION FOR OPTILIBRIA")
    print("="*60)
