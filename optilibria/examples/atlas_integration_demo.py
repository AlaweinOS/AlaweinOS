#!/usr/bin/env python3
"""
ATLAS-Optilibria Integration Demo

Demonstrates how to use Optilibria with MEZAN/ATLAS for multi-agent
...
def demo_standalone_agent():
    """
    Demo: Deploy Optilibria as a standalone ATLAS agent
    """
    from optilibria.integrations.atlas import OptilibriaAgent, ATLASConfig

    print("\n" + "="*60)
    print("DEMO: Standalone Optilibria Agent")
    print("="*60)

    # Configure agent
    config = ATLASConfig(
        agent_id="optilibria-demo-agent",
...
def demo_task_submission():
    ...
    """
    from optilibria.integrations.atlas import ATLASOptimizationAdapter, ATLASConfig
...
def demo_atlas_integration():
    """
    Demo: Full ATLAS integration example
    """
    print("\n" + "="*60)
    print("DEMO: Complete ATLAS Integration")
    print("="*60)

    # This would be called from within an ATLAS agent
    class OptimizationResearchAgent:
        """Example ATLAS agent that uses Optilibria"""
        ...
        def execute_optimization_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
            ...
            # Return task info for ATLAS orchestration
            return {
...
def main():
    ...
    """
    print("\n" + "="*70)
    print(" ATLAS-OPTILIBRIA INTEGRATION DEMONSTRATION")
    print("="*70)
