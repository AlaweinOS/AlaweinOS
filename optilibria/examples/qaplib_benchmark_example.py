...
def demo_optilibria_integration():
    """Demonstrate integration with Optilibria optimization methods"""
    print("\n" + "=" * 80)
    print("OPTILIBRIA INTEGRATION")
    print("=" * 80)
...
def demo_benchmarking():
    ...
    # Define wrapper functions for Optilibria methods
