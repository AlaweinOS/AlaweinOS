#!/usr/bin/env python3
"""
GPU Acceleration Demo for Optilibria
...
from optilibria.acceleration import (
    GPUBackend,
    enable_mixed_precision,
    disable_mixed_precision,
)
from optilibria.acceleration.gpu_methods import (
    GPUGeneticAlgorithm,
    GPUParticleSwarm,
...
from optilibria.acceleration.gpu_methods.gpu_simulated_annealing import SimulatedAnnealingConfig
...
def compare_backends():
    ...
    print("=" * 80)
    print("OPTILIBRIA GPU ACCELERATION DEMO")
    print("=" * 80)
...
def main():
    ...
    print("\n")
    print("🚀 " + "=" * 76 + " 🚀")
    print("   OPTILIBRIA GPU ACCELERATION DEMONSTRATION")
    print("🚀 " + "=" * 76 + " 🚀")
