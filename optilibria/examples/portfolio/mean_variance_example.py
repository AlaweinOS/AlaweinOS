...
This example demonstrates how to use Optilibria's portfolio optimization
framework to solve the classic Markowitz mean-variance optimization problem.
"""

import numpy as np
import pandas as pd
from optilibria.domains.portfolio import (
    PortfolioProblem,
    ProblemType,
...
def main():
    ...
    # Use Optilibria's optimization engine
    result = optimize(
...
if __name__ == "__main__":
    ...
    from optilibria.core.interfaces import StandardizedSolution
    main()