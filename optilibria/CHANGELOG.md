...
All notable changes to Optilibria will be documented in this file.
...
For detailed changes, see the [commit history](https://github.com/yourusername/optilibria/commits/main).
