...
# QAPlibria Method Taxonomy & Classification
...
QAPlibria currently contains **32 optimization methods** consolidated from three repositories (qap-claude, qap-codex, qap-gemini). This taxonomy provides a rigorous classification system distinguishing between:
...
**Next Review**: Q4 2025
**Contact**: QAPlibria Development Team