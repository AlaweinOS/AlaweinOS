...
| 2 | **Momentum** | ★ QAPlibria | ⭐⭐ Custom decay | ✅ Implemented | O(n³) | +15-20% |
...
| 7 | **Constraint Forces** | ★ QAPlibria | ⭐⭐ Novel | ✅ Implemented | O(n²) | Standard |
| 8 | **Hybrid Sinkhorn-Forces** | ★ QAPlibria | ⭐⭐ Adaptive | ❌ Missing | O(n²×k) | Expected +10-20% |
...
| 12 | **Adaptive Step** | ★ QAPlibria | ⭐⭐ Custom | ❌ Missing | O(n³) | Expected stability |
...
| 15 | **Continuation** | ★ QAPlibria | ⭐⭐ Custom annealing | ❌ Missing | O(1) | Expected better |
...
| 17 | **Gradient Stagnation** | ★ QAPlibria | ⭐ Simple | ✅ Implemented | O(n²) | Simple |
| 18 | **Reverse Time** | ★ QAPlibria | ⭐⭐⭐ High novelty | ✅ Implemented | O(n³×10) | 90% escape |
...
| 21 | **Probabilistic** | ★ QAPlibria | ⭐⭐ Custom | ❌ Missing | O(n²) | N/A |
| 22 | **Iterative Refinement** | ★ QAPlibria | ⭐⭐ Novel | ❌ Missing | O(n²×k) | N/A |
...
| 27 | **Combinatorial Clustering** | ★ QAPlibria | ⭐⭐ Novel | ❌ Missing | O(n³) | Expected +10-20% |
...
| 29 | **Basin Clustering** | ★ QAPlibria | ⭐⭐ Novel | ❌ Missing | O(kn_starts) | Better explore |
| 30 | **Parallel Gradients** | • Baseline | ⭐ Standard | ❌ Missing | O(T/p) | 2-3× coverage |
| 31 | **Adaptive Lambda** | ★ QAPlibria | ⭐⭐ Custom | ❌ Missing | O(1) | +20% |
...
- **File**: `qaplibria/methods/novel/hybrid_methods.py`
...
- **File**: `qaplibria/methods/novel/adaptive_integrator.py`
...
- **File**: `qaplibria/methods/novel/eigenvalue_methods.py`
...
- **File**: `qaplibria/methods/novel/fft_methods.py`
...
- **File**: `qaplibria/saddle_escape.py`
