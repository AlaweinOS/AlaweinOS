...
# QAPLibria: Complete Method Reference
...
QAPLibria implements **34 optimization methods** for solving the Quadratic Assignment Problem, consisting of:
...
**Novel Methods (★)** - QAPLibria Original Contributions:
