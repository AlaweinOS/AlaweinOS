...
This document defines the backward compatibility policy for the Optilibria optimization framework, ensuring smooth upgrades and migrations for users.

## Semantic Versioning

Optilibria follows [Semantic Versioning 2.0.0](https://semver.org/):
