...
Documentation for advanced and novel optimization methods in Optilibria.

## Baseline Methods

Optilibria includes 5 production-ready baseline methods:
...
```python
from optilibria.ai.method_selector import select_method
