"""
ATLAS with Personality Agents Demo
...
async def main():
    """
    Run ATLAS with personality agents enabled
    """
    print("\n" + "="*80)
    print("🎭 ATLAS PERSONALITY AGENTS DEMO")
    print("="*80)
    print()
    print("This demo shows how ATLAS uses personality-based agents")
    ...
    # Initialize ATLAS with meta-learning enabled
