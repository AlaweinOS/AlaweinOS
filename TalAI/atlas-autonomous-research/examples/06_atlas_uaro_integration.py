"""
Example 6: ATLAS-UARO Integration
...
def main():
    """Demonstrate ATLAS-UARO integration"""

    print("=" * 70)
    print("UARO Example 6: ATLAS-UARO Integration")
    print("=" * 70)
    print()
    ...
    if result1['extracted_primitive']:
        ...
        listing_id = integration.publish_learned_workflow(
            ...
            tags=['literature_review', 'research', 'atlas', 'machine_learning']
        )
    ...
    print("   - ATLAS tasks automatically converted to UARO problems")
