...
app = typer.Typer(help="ATLAS - Autonomous Research System (NOT Nobel Turing Challenge)")
console = Console()
...
def research(
    ...
    """
    console.print("\n[bold cyan]ATLAS - Autonomous Research System[/bold cyan]")
    ...
    if preflight:
        from atlas.diagnostics import run_diagnostics, summarize_diagnostics
    ...
    if with_orchestrator:
        try:
            ...
            console.print("[yellow]⚠️[/yellow] atlas-orchestrator not available\n")
...
def info():
    ...
    console.print("\n[bold]ATLAS - Autonomous Theorist & Laboratory Autonomous System[/bold]\n")
    console.print("Version: 0.1.0\n")

    console.print("[yellow]⚠️  IMPORTANT DISCLAIMER[/yellow]")
    console.print("This is NOT the Nobel Turing Challenge.")
    console.print("ATLAS is a computational research prototype inspired by")
    ...
    console.print("[cyan]What ATLAS CAN do:[/cyan]")
