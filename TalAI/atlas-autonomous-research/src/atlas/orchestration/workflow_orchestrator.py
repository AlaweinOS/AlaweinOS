"""
ATLAS Orchestration - Workflow Orchestrator

Dynamically configures ATLAS pipeline based on problem type.
...
from atlas.orchestration.problem_types import (
    ProblemType,
    ProblemCharacteristics,
    get_problem_config
)
from atlas.orchestration.intent_classifier import (
    IntentClassifier,
...
class WorkflowConfig:
    """Configuration for ATLAS workflow execution"""
...
class WorkflowOrchestrator:
    """
    Orchestrates ATLAS workflow based on problem type.
    ...
    def plan_workflow(
        ...
        """
        Plan ATLAS workflow for a research query
    ...
    def get_workflow_summary(self, config: WorkflowConfig) -> str:
        ...
        summary_parts = [
            "=" * 80,
            "ATLAS ADAPTIVE WORKFLOW CONFIGURATION",
            "=" * 80,
            "",
...
def plan_research_workflow(
    ...
    """
    Plan ATLAS research workflow for a query
