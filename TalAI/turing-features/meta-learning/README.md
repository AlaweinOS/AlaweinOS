...
Part of [Project ATLAS](../../../MASTER_SUPER_PLAN.md)
...
Meta-learning is built into ATLAS:

```python
from atlas import ATLASProtocol

# ATLAS automatically uses meta-learning
atlas = ATLASProtocol()

# Agents learn from each project
project = await atlas.run_research("Your topic", "optimization")
