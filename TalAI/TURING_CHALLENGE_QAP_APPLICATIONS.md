...
13. [Integration with QAPlibria](#integration-with-qaplibria)
...
│     - Many proposed methods (30+ in QAPlibria)               │
...
from qaplibria.turing_challenge import QAPDomainAdapter, TuringChallengeSystem
...
def qap_research_workflow(research_question):
    ...
    # 4. Execute experiment with QAPlibria
...
- Integrates seamlessly with QAPlibria
...
2. Integrate with QAPlibria core solver
