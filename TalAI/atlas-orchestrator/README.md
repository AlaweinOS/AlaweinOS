...
Part of [Project ATLAS](../../MASTER_SUPER_PLAN.md) - Autonomous Theorist & Laboratory Autonomous System

---

## 🎯 What It Does

ATLAS Orchestrator intelligently routes AI tasks across multiple models (Claude, GPT-4, Gemini, local models) to optimize for:
...
```bash
pip install atlas-orchestrator
```
...
- `ATLAS_PREFLIGHT=1` (from the ATLAS CLI) — ensures orchestrator imports succeed before long research runs.
...
Full documentation: https://yourorg.github.io/atlas-orchestrator
...
This is the **AI Orchestrator** component of [Project ATLAS](../../MASTER_SUPER_PLAN.md), a Nobel-level autonomous research platform.

**Other ATLAS Components**:
