"""High-level LLM client wrapper for ATLAS Orchestrator.

This module provides a small, reusable interface for other tal-ai systems
(ATLAS Autonomous Research, Turingo, etc.) to call the orchestrator
...
async def llm_call(
    ...
    *,
    ...
    """Execute a single LLM task via ATLAS Orchestrator.
