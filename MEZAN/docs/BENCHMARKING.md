...
This guide provides comprehensive documentation for benchmarking the MEZAN/ATLAS system, including performance metrics, testing methodologies, and optimization strategies.
...
# Profile application
py-spy top --pid $(pgrep -f atlas)  # Python profiling
strace -p $(pgrep -f atlas)  # System calls
