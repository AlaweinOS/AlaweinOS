...
**Min-max optimization for robust ATLAS workflows under worst-case scenarios**

## Overview

DualLibria solves adversarial robust optimization problems using alternating minimization-maximization, finding configurations that perform well even under worst-case perturbations.
...
DualLibria uses coordinate ascent/descent:
...
```python
class DualLibriaSolver(OptimizerInterface):
    def __init__(
        self,
