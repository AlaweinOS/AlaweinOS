...
│   │   └── benchmarks/
│   │
│   ├── qaplibria/                     # Agent-task assignment (QAP)
│   │   ├── pyproject.toml
│   │   ├── README.md
...
│   │
│   ├── flowlibria/                    # Workflow routing (MAB)
│   │   ├── pyproject.toml
│   │   ├── README.md
│   │   ├── PAPER.md
│   │   ├── src/
...
│   │   └── benchmarks/
│   │
│   ├── duallibria/                    # Adversarial robustness
│   │   ├── pyproject.toml
│   │   ├── README.md
│   │   ├── PAPER.md
│   │   ├── src/
...
### Individual Solvers (Example: qaplibria)
```toml
[project]
name = "qaplibria"
version = "0.1.0"
...
pip install -e packages/qaplibria
pip install -e packages/flowlibria
...
- **qaplibria**: Apache 2.0 (basic implementation)
- **flowlibria**: Apache 2.0 (basic implementation)

### Commercial (Premium Features)
- **qaplibria-pro**: GPU acceleration, synergy modeling
- **metalibria**: Full solver selection (basic free)
- **duallibria**: Commercial only
- **evolibria**: Commercial only

### PyPI Publishing
```bash
# Build all packages
python -m build packages/libria-core
python -m build packages/qaplibria
# ...
...
2. **Copy pyproject.toml template**:
   ```bash
   cp packages/qaplibria/pyproject.toml packages/newsolver/
...
2. **Week 2**: Implement QAPLibria and integrate with monorepo
3. **Week 3**: Add FlowLibria and establish CI/CD patterns
