...
In multi-agent AI systems (like MEZAN/ATLAS), traditional optimization methods fall short because they don't account for:
...
**Use Case:** Assigning research agents to subtasks in ATLAS workflows
...
**Use Case:** Routing research tasks through ATLAS agents based on their historical accuracy
...
**Use Case:** Allocating Claude/GPT API credits across ATLAS agents
...
**Use Case:** Optimizing agent-to-agent communication in distributed ATLAS
...
**Use Case:** Ensuring ATLAS workflows work even with agent failures
...
**Use Case:** Balancing speed vs. quality vs. cost in ATLAS
...
## Integration with MEZAN/ATLAS

The Libria Suite integrates with MEZAN/ATLAS in several ways:
...
- **[PROMPT_QAPLibria.md](PROMPT_QAPLibria.md)** - QAP solver prompt (30K)
- **[PROMPT_FlowLibria.md](PROMPT_FlowLibria.md)** - Flow solver prompt (24K)
- **[PROMPT_AllocLibria.md](PROMPT_AllocLibria.md)** - Allocation solver prompt (20K)
- **[PROMPT_GraphLibria.md](PROMPT_GraphLibria.md)** - Graph solver prompt (17K)
- **[PROMPT_DualLibria.md](PROMPT_DualLibria.md)** - Dual solver prompt (22K)
- **[PROMPT_EvoLibria.md](PROMPT_EvoLibria.md)** - Evolutionary solver prompt (20K)
- **[PROMPT_MetaLibria.md](PROMPT_MetaLibria.md)** - Meta solver prompt (37K)
...
- **Operations Research (OR):** QAPLibria, AllocLibria
- **ICML/NeurIPS:** FlowLibria, GraphLibria, MetaLibria
- **AAMAS (Multi-Agent Systems):** DualLibria, EvoLibria
...
- **Optilibria:** General-purpose optimization framework (see `/optilibria/`)
- **MEZAN/ATLAS:** Multi-agent AI orchestration system
