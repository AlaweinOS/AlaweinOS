...
```
function TRAIN_METALIBRIA(instances, features, runtimes, k):
...
- Performance: MetaLibria rank 1/7 (best on this scenario)
...
- Performance: MetaLibria rank 2/7, 96.5% top-1 accuracy
...
- Performance: MetaLibria rank 4/7
...
- Performance: MetaLibria rank 5/7 (weak on this scenario)
