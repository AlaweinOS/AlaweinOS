"""
Ablation Studies for MetaLibria
...
class AblationStudy:
    """
    Framework for running ablation studies on MetaLibria
    """
    ...
    def study_n_clusters(
        ...
        for scenario in scenarios:
            ...
            for n_clusters in cluster_values:
                ...
                # Create MetaLibria with specific n_clusters
                meta = MetaLibria(
                    solvers=solvers,
    ...
    def study_ucb_constant(
        ...
        for scenario in scenarios:
            ...
            for ucb_c in ucb_values:
                ...
                # Create MetaLibria with specific ucb_c
                meta = MetaLibria(
                    solvers=solvers,
                    n_clusters=5,
                    elo_k=32.0,
    ...
    def study_tournament_rounds(
        ...
        for scenario in scenarios:
            ...
            for n_rounds in rounds_values:
                ...
                # Create MetaLibria with specific n_rounds
                meta = MetaLibria(
                    solvers=solvers,
                    n_clusters=5,
                    elo_k=32.0,
    ...
    def study_elo_k_factor(
        ...
        for scenario in scenarios:
            ...
            for elo_k in k_values:
                ...
                # Create MetaLibria with specific elo_k
                meta = MetaLibria(
                    solvers=solvers,
                    n_clusters=5,
                    elo_k=elo_k,
