...
Compare MetaLibria's default configuration vs. optimal configuration
...
def test_config(scenario_name, n_clusters, elo_k, ucb_c, n_tournament_rounds, config_name):
    ...
    # Create MetaLibria with specific config
    metalibria = MetaLibria(
        solvers=solvers,
    ...
    for test_instance in test_data:
        ...
        start_time = time.time()
        selected = metalibria.select_solver(instance, features=features)
