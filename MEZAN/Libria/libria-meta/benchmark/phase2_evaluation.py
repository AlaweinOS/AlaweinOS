...
Tests MetaLibria (default vs optimal config) against all baselines
...
from benchmark.evaluate_metalibria import create_mock_solver_for_aslib
...
class Phase2Evaluator:
    ...
    def evaluate_scenario(
        ...
        Args:
            ...
            test_optimal_config: If True, test both default and optimal MetaLibria
        ...
        # MetaLibria - Default configuration
        methods['MetaLibria (default)'] = MetaLibria(
            solvers=solvers,
            n_clusters=5,
            elo_k=32.0,
            ucb_c=1.414,
        ...
        # MetaLibria - Optimal configuration (if requested)
        if test_optimal_config:
            methods['MetaLibria (optimal)'] = MetaLibria(
                solvers=solvers,
