# MetaLibria: Complete 12-Week Project Summary
...
We successfully completed a 12-week research project culminating in the submission of "MetaLibria: Tournament-Based Meta-Learning for Fast Algorithm Selection" to AutoML 2025 conference. The project demonstrates that tournament-based meta-learning achieves competitive algorithm selection accuracy (best average regret: 0.0545) with extreme speed (0.15ms, 1664× faster than SATzilla). MetaLibria excels on graph problems (rank 1/7 on GRAPHS-2015) while remaining hyperparameter robust—only the number of clusters impacts performance.
...
**Core Implementation**:
- MetaLibria framework (410 lines, 16 tests)
...
**Key Results**:
- **MetaLibria achieves BEST average regret: 0.0545**
...
- MetaLibria: 0.15ms selection time
...
**Deployment Guidance**: Use MetaLibria for graph-heavy applications, simple selection, and real-time systems
...
|--------|------------|-----------|-----------|---------|
| **MetaLibria (optimal)** | **0.0545** | 46.5% | **0.15** | **1664×** |
| MetaLibria (default) | 0.0587 | 45.1% | 0.17 | 1494× |
...
**Repository**: `https://github.com/metalibria-automl/metalibria`
**License**: MIT (open-source)

### Repository Structure

- **Core Implementation**: 410 lines (MetaLibria) + 1,306 lines (baselines)
...
4. **LaTeX Files**: metalibria_paper.tex + appendix_complete.tex
