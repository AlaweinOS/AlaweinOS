...
**Methods Compared**: 6 (MetaLibria + 5 baselines)
...
| **MetaLibria** | 0.0709 🥉 | 0.23 | 0.56 | **0.45** 🥈 |
...
#### Pairwise Comparisons (MetaLibria vs. Others)
...
- MetaLibria numerically close to Hyperband and SATzilla
...
|--------|--------------|----------------|--------|-----------|-----------|
| MetaLibria | 0.072 | 0.30 | 0.076 | 18% | 56% |
...
| Method | Training (s) | Selection (ms) | Regret | Top-1 Acc | Top-3 Acc |
|--------|--------------|----------------|--------|-----------|-----------|
| MetaLibria | 0.071 | 0.46 | 0.089 | 16% | 44% |
...
| Method | Training (s) | Selection (ms) | Regret | Top-1 Acc | Top-3 Acc |
|--------|--------------|----------------|--------|-----------|-----------|
| **MetaLibria** | 0.060 | **0.58** | **0.047** | **36%** | **68%** |
...
| BOHB | 0.027 | 27x |
| **MetaLibria** | **0.066** | **66x** |
| SMAC | 0.108 | 108x |
| AutoFolio | 0.770 | 770x |
| SATzilla | 1.253 | **1,253x** |

**MetaLibria**: Mid-range training time (0.066s on 100 instances)
...
**MetaLibria**: Second-fastest (0.446ms per selection)
...
- Scatter plots (MetaLibria vs. each baseline)
...
**Key Result**: MetaLibria is **competitive** with state-of-the-art baselines:
