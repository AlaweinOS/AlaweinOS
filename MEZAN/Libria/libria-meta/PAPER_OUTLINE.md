...
**4.2 MetaLibria Framework** (0.5 pages)
- **Overview diagram** (Figure 1: MetaLibria architecture)
...
6. **MetaLibria (default)**: Standard hyperparameters
7. **MetaLibria (optimal)**: Tuned hyperparameters (n_clusters=3)
...
|--------|--------------|-------------|------------------|---------------------|
| **MetaLibria (optimal)** | **0.0545** | 46.5% | **0.15ms** | **1664x** |
| MetaLibria (default) | 0.0587 | 45.1% | 0.17ms | 1494x |
...
| Scenario | MetaLibria Rank | Regret | Top-1 Acc | Notes |
|----------|----------------|--------|-----------|-------|
...
- **Figure 3: Pareto frontier** (scatter plot: selection time vs regret)
  - MetaLibria: Optimal trade-off (fast + competitive)
...
- Introduced MetaLibria: tournament-based meta-learning for algorithm selection
...
3. **Figure 3: Speed-Accuracy Pareto Frontier** (Results section)
   ...
   - Show MetaLibria in optimal region (fast + competitive)
...
- Pseudocode for MetaLibria training and selection
