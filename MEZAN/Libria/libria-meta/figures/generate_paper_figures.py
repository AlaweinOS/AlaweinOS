"""
Generate Figures for MetaLibria Paper
...
def figure2_scenario_performance():
    ...
    # Reorder scenarios by MetaLibria (optimal) performance
    ml_optimal = pivot['MetaLibria (optimal)']
...
def figure3_pareto_frontier():
    ...
    colors = {
        'MetaLibria (optimal)': '#e74c3c',  # Red
        'MetaLibria (default)': '#e67e73',  # Light red
    ...
    for _, row in agg.iterrows():
        ...
        # Size: highlight MetaLibria
        size = 200 if 'MetaLibria' in method else 100
    ...
    pareto_methods = ['Hyperband', 'MetaLibria (optimal)', 'SATzilla']
    ...
    # Annotate MetaLibria (optimal)
    ml_row = agg[agg['Method'] == 'MetaLibria (optimal)'].iloc[0]
