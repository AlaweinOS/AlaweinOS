...
- **5.1 Overall Performance**: Table 1 showing best average regret (0.0545)
  - MetaLibria beats all 6 baselines on average
...
- **5.2 Per-Scenario Performance**: Table 2 + problem class analysis
  ...
  **Key finding**: MetaLibria excels on graph problems and simple selection

- **5.3 Speed-Accuracy Trade-off**: Pareto frontier analysis
  - MetaLibria fills gap: <1ms selection with competitive accuracy
...
1. **Figure 2: Per-Scenario Performance** (grouped bar chart)
   ...
   - Highlights MetaLibria wins on GRAPHS-2015 (gold star)
...
2. **Figure 3: Speed-Accuracy Pareto Frontier** (scatter plot)
   ...
   - Annotates MetaLibria: "1664× faster than SATzilla"
   - Shades real-time region (<1ms)
   - Shows MetaLibria's optimal position in speed-accuracy space
