# MetaLibria: Compact Progress Summary
...
- Core MetaLibria (410 lines, 16 tests)
...
|--------|------------|-----------|-------|------|
| **MetaLibria (optimal)** | **0.0545** 🥇 | 46.5% | **0.15ms** | **1st** |
| MetaLibria (default) | 0.0587 | 45.1% | 0.17ms | 2nd |
...
### Discovery 3: MetaLibria Excels on Graph Problems 🎯
