...
- Adapter: `Libria/libria-meta/qaplibria_backend.py` maps MEZAN problem format to QAP A/B and calls modular solvers
...
- Set the modular repo path to its `src` directory:
  - WSL/Linux: `export QAP_MODULAR_REPO_PATH="/mnt/c/Users/mesha/Documents/Projects/Active/QAPlibria/projects/QAP_modular_repo-main/src"`
  - Windows PowerShell: `$env:QAP_MODULAR_REPO_PATH="C:\\Users\\mesha\\Documents\\Projects\\Active\\QAPlibria\\projects\\QAP_modular_repo-main\\src"`
...
Files
- Adapter: `Libria/libria-meta/qaplibria_backend.py`
