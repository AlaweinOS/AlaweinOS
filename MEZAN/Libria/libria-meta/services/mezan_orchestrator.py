...
import qaplibria_backend  # type: ignore
    ...
    def do_POST(self):  # noqa: N802
        ...
        try:
            if self.path in ('/qapflow/solve','/qapflow/solve_ab'):
                ...
                def _run():
                    try:
                        res_holder['res'] = qaplibria_backend.solve(payload, parameters=params or None)
                ...
                if req_timeout > 0:
                    ...
                    res = qaplibria_backend.solve(payload, parameters=params or None)
