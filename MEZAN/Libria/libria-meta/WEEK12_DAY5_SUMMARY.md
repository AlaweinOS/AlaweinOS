...
- CSP-2010: SMAC/MetaLibria tied best (0.003 regret), MetaLibria 0.13ms
- GRAPHS-2015: **MetaLibria WINS** (0.019 regret, 0.548 top-1), SATzilla 224.7ms
- MAXSAT12-PMS: Hyperband/MetaLibria tied (0.023 regret)
...
- 5 pairwise comparisons (MetaLibria vs. each baseline)
...
**Code Availability**:
- Repository: `https://github.com/[anonymous]/metalibria-automl2025`
