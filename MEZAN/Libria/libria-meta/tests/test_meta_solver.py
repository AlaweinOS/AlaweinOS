"""
Unit tests for MetaLibria tournament-based solver selection
"""
...
def meta_libria(mock_solvers):
    """Create MetaLibria instance with mock solvers"""
    return MetaLibria(solvers=mock_solvers, n_clusters=2, n_tournament_rounds=3)
