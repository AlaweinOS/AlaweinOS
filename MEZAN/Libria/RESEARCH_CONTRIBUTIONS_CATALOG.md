...
6. Experiments: QAPLIB + ATLAS workflows
...
6. Experiments: Synthetic time-series + ATLAS daily allocations
...
5. Experiments: ATLAS workflows, baselines (always validate, threshold, random)
...
**Data Requirements**:
- 500+ ATLAS workflow executions with outcomes
...
**Data Requirements**:
- Same as Contribution #4 (ATLAS workflows)
...
6. Experiments: Synthetic scenarios + ATLAS workflows
...
Phase 1: Automated Attack Generation
  - Generate 1000+ attacks from MITRE ATLAS templates
...
class PreDeploymentValidator:
    def __init__(self, workflow, attack_catalog):
        ...
        self.attack_catalog = attack_catalog  # 207+ MITRE ATLAS vectors
    ...
    def generate_attacks(self, num):
        """Generate attacks from MITRE ATLAS templates"""
        attacks = []
        for _ in range(num):
...
- Vulnerability coverage: % of MITRE ATLAS vectors tested
...
- MITRE ATLAS integration shows real-world relevance
...
5. Experiments: ATLAS workflows, MITRE ATLAS attacks
...
**Core Components**:
1. Attack catalog: MITRE ATLAS 207+ vectors
...
**Data Requirements**:
- ATLAS workflows (multiple workflow types)
- MITRE ATLAS attack templates
...
6. Experiments: ATLAS workflows, attack scenarios
...
|----|-------------|--------|---------|-------------------|----------|
| QAP-C1 | Contextual QAP with Learned Costs | QAPLibria | 🟢 STRONG | EJOR | Month 9 |
| QAP-C2 | Warm-Start QAP for Time-Series | QAPLibria | 🟢 STRONG | INFORMS Journal on Computing | Month 9 |
| QAP-C3 | Spectral Init + Online Learning Hybrid | QAPLibria | 🟢 STRONG | Operations Research | Month 12 |
| FLOW-C1 | Confidence-Aware Routing with Learned Policies | FlowLibria | 🟢 STRONG | AAMAS 2026 | Nov 2025 |
| FLOW-C2 | Validation Quality as Explicit Objective | FlowLibria | 🟢 STRONG | AAAI 2026 | Aug 2025 |
| ALLOC-C1 | Multi-Agent Constrained Thompson Sampling | AllocLibria | 🟢 MODERATE-STRONG | ICML 2026 | Jan 2026 |
| ALLOC-C2 | Dynamic Constraint Adaptation | AllocLibria | 🟢 MODERATE-STRONG | NeurIPS 2025 or ICML 2026 | May 2025 or Jan 2026 |
| GRAPH-C1 | Information-Theoretic Topology Optimization | GraphLibria | 🟢 STRONG | NeurIPS 2025 | May 2025 |
| GRAPH-C2 | Dynamic Topology Adaptation | GraphLibria | 🟢 STRONG | ICML 2026 | Jan 2026 |
| META-C1 | Tournament-Based Competitive Evaluation | MetaLibria | 🟢 MODERATE-STRONG | AutoML 2025 | **March 31, 2025** ⚠️ |
| DUAL-C1 | Pre-Deployment Adversarial Validation | DualLibria | 🟢 STRONG | NeurIPS 2025 | May 2025 |
| DUAL-C2 | Workflow-Level Min-Max Optimization | DualLibria | 🟢 STRONG | IEEE S&P 2026 or ICLR 2026 | Nov 2025 or Sep 2025 |
| EVO-C1 | Evolutionary Search for Coordination Patterns | EvoLibria | 🟢 STRONG | NeurIPS 2025 or GECCO 2025 | May 2025 or Jan 2025 |
| EVO-C2 | Quality-Diversity for Agent Architectures | EvoLibria | 🟢 MODERATE-STRONG | ICML 2026 or GECCO 2025 | Jan 2026 or Jan 2025 |
...
*Next Review: After implementation of first solver (MetaLibria)*
