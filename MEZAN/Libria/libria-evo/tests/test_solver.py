...
class TestEvoLibriaSolver:
    ...
    def test_solve(self, multi_objective_problem):
        solver = EvoLibriaSolver(config={"population_size": 20, "num_generations": 30})
        solver.initialize()
    ...
    def test_pareto_front_quality(self, multi_objective_problem):
        solver = EvoLibriaSolver(config={"population_size": 30, "num_generations": 50})
        solver.initialize()
        result = solver.solve(multi_objective_problem)
