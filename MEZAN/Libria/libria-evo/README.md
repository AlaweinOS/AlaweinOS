...
**NSGA-II for finding Pareto-optimal trade-offs in ATLAS workflows**

## Overview

EvoLibria solves multi-objective optimization problems using NSGA-II (Non-dominated Sorting Genetic Algorithm II), finding Pareto-optimal solutions that balance multiple conflicting objectives.
...
```python
class EvoLibriaSolver(OptimizerInterface):
    def __init__(
        self,
