# GraphLibria - Information-Theoretic Network Topology Optimization

**Optimize ATLAS agent communication networks using information theory**

## Overview

GraphLibria optimizes network topology for multi-agent systems by minimizing information entropy while respecting communication constraints.
...
GraphLibria uses a greedy algorithm:
...
```python
solver = GraphLibriaSolver(config={
...
```python
class GraphLibriaSolver(OptimizerInterface):
    def __init__(
        self,
