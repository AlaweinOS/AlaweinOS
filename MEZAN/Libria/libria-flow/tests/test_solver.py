"""
Comprehensive tests for FlowLibria solver
"""
...
class TestFlowLibriaSolver:
    """Test suite for FlowLibria solver"""
...
class TestFlowLibriaAlgorithms:
...
class TestFlowLibriaBenchmarks:
