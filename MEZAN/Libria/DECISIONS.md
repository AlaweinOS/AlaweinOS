# Optilibria Suite & TURING Platform - Decision Matrix

## Strategic Decisions

### Decision 1: Platform Branding Strategy
**Decision**: TURING as unified platform with ATLAS/UARO as engines
**Rationale**:
- Creates coherent brand identity
- Turing name evokes universal computation
- Separates platform (TURING) from technology (Optilibria)
**Alternatives Considered**:
- Keep ATLAS/UARO separate: Too fragmented
- Optilibria as main brand: Confuses solvers with platform
...
**Decision**: Use $1000 account for TURING, $500 for Optilibria Suite
**Rationale**:
...
### Decision 3: QAPLibria as Flagship Solver
**Decision**: Prioritize QAPLibria validation and publication first
**Rationale**:
- Already have partial implementation
- Clear benchmarks available (QAPLIB)
- Foundational for agent assignment in TURING
**Alternatives Considered**:
- Start with FlowLibria: No existing code
- Do all solvers equally: Spreads effort too thin
**Validation**: QAPLibria shows 20%+ improvement in Week 2
**Revisit Conditions**: If QAPLibria doesn't validate, pivot to FlowLibria
...
### Decision 10: Thompson Sampling for AllocLibria
...
### Related Docs
- Optilibria Novelty Overview: [NOVELTY_ANALYSIS_OVERVIEW.md](../../../optilibria/docs/integration/NOVELTY_ANALYSIS_OVERVIEW.md)
- Complete Novelty Analysis: [NOVELTY_ANALYSIS_COMPLETE.md](../../../optilibria/docs/integration/summaries/NOVELTY_ANALYSIS_COMPLETE.md)
- QAPlibria Documentation Suite: [QAP_DOCS_OVERVIEW.md](../../../optilibria/docs/integration/QAP_DOCS_OVERVIEW.md)
