...
Get up and running with the ATLAS Engine in 5 minutes!
...
```
======================================================================
ATLAS Engine Demo - Multi-Agent Research Orchestration
======================================================================

1. Initializing ATLAS Engine...
2025-11-14 - atlas_core.engine - INFO - ATLAS Engine initialized

2. Registering 10 research agents...
2025-11-14 - atlas_core.agent - INFO - Initialized synthesis agent: agent_00
...

3. ATLAS Engine Statistics:
   Total agents: 10
...
# Initialize ATLAS Engine (without Libria for now)
...
print(f"Registered {len(atlas.agents)} agents")
...
for agent_id, agent in atlas.agents.items():
...
# - QAPLibria for task assignment
# - FlowLibria for workflow routing
# - GraphLibria for topology optimization
```
...
**Solution**:
```bash
# Make sure you're in the atlas-core directory
cd atlas-core
...
# Or use ATLAS in mock mode (no Redis needed)
atlas = ATLASEngine(libria_enabled=False)
```
...
2. ⏳ Enable Libria: `atlas = ATLASEngine(libria_enabled=True)`
3. ⏳ Test integration with QAPLibria
