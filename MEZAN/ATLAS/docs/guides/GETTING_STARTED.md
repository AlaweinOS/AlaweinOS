# Getting Started with ATLAS Transformation Platform
...
mkdir atlas-nightmare-validator
...
gh repo create atlas-nightmare-validator --public
git remote add origin https://github.com/YOUR_ORG/atlas-nightmare-validator.git
