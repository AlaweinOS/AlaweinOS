...
[ ] Analyze current mix: Apache 2.0 (Optilibria) vs MIT (most tools)
...
[ ] Document institutional affiliations (UC Berkeley for Optilibria)
...
[ ] For Optilibria: Maintain "UC Berkeley" attribution in acknowledgments
...
[ ] Projects at v1.0.0+ (production): Optilibria
...
[ ] Comprehensive docs: Optilibria, [list others]
...
[ ] Current status: Only Optilibria has one
