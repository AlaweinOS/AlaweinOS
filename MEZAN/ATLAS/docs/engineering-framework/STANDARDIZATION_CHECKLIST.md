...
Institution attribution - Only Optilibria mentions UC Berkeley
...
CODEOWNERS - Only Optilibria has one
...
Architecture diagrams - Only Optilibria has some
...
Optilibria - Project type shows "research-library" but still has unknown in some scans
...
CITATION.cff - For research projects (especially Optilibria)
