...
This document describes the standard repository structure for the ATLAS Hypothesis Evaluation Platform.
...
The main package is located in `src/atlas/` following Python best practices:

- **`src/` layout**: Prevents accidental imports from project root
- **Package imports**: All imports use `from atlas.module import ...`
