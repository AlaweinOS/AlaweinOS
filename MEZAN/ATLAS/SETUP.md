...
Quick setup instructions for the ATLAS Hypothesis Evaluation Platform.
...
```bash
make run
# Or: python -m atlas.atlas_api_server
```
...
```bash
make docker-build
docker run -p 5000:5000 --env-file .env atlas-api:latest
```
