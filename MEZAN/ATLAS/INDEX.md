# ATLAS Engine - Complete Documentation Index
...
**New to ATLAS?** Start with these 3 documents in order:

1. **[QUICK_START.md](QUICK_START.md)** (5 min) - Get running immediately
2. **[atlas-core/README.md](atlas-core/README.md)** (15 min) - Complete usage guide
...
| [atlas-core/README.md](atlas-core/README.md) | Complete usage guide | 15 min | ⭐⭐⭐ |
| [demo.py](atlas-core/demo.py) | Working code example | Code | ⭐⭐ |
...
| Document | Purpose | Time | Priority |
|----------|---------|------|----------|
| [atlas-core/AGENT_EXPANSION_GUIDE.md](atlas-core/AGENT_EXPANSION_GUIDE.md) | Expand to 40+ agents | 20 min | ⭐⭐ |
...
|------|-------|---------|--------|
| [atlas_core/engine.py](atlas-core/atlas_core/engine.py) | 357 | Main orchestration | ✅ |
| [atlas_core/agent.py](atlas-core/atlas_core/agent.py) | 142 | Base agent class | ✅ |
| [atlas_core/agents.py](atlas-core/atlas_core/agents.py) | 356 | 8 concrete agents | ✅ |
| [atlas_core/blackboard.py](atlas-core/atlas_core/blackboard.py) | 227 | Redis connector | ✅ |
| [atlas_core/libria_mock.py](atlas-core/atlas_core/libria_mock.py) | 185 | Mock router | ✅ |

### Testing

| File | Lines | Purpose | Status |
|------|-------|---------|--------|
| [tests/test_engine.py](atlas-core/tests/test_engine.py) | 104 | 7 engine tests | ✅ |
| [tests/test_agents.py](atlas-core/tests/test_agents.py) | 117 | 8 agent tests | ✅ |

### Configuration

| File | Lines | Purpose | Status |
|------|-------|---------|--------|
| [requirements.txt](atlas-core/requirements.txt) | 7 | Dependencies | ✅ |
| [setup.py](atlas-core/setup.py) | 24 | Package setup | ✅ |
...
3. Read [atlas-core/README.md](atlas-core/README.md)
...
3. Browse source code in `atlas-core/atlas_core/`
...
1. Read [atlas-core/AGENT_EXPANSION_GUIDE.md](atlas-core/AGENT_EXPANSION_GUIDE.md)
...
1. Read [atlas-core/README.md](atlas-core/README.md) - Architecture section
...
2. Review [atlas-core/README.md](atlas-core/README.md) - Development section
...
2. **[demo.py](atlas-core/demo.py)** - See it work
3. **[atlas-core/README.md](atlas-core/README.md)** - Understand basics
...
4. **[tests/](atlas-core/tests/)** - Understand tests
5. **[INTEGRATION_CHECKLIST.md](INTEGRATION_CHECKLIST.md)** - Next steps

### Advanced Path (1-2 days)
1. Complete Intermediate Path
2. **[atlas-core/AGENT_EXPANSION_GUIDE.md](atlas-core/AGENT_EXPANSION_GUIDE.md)** - Expansion
...
- QAPLibria integration
- FlowLibria integration
- Integration tests
- Expand to 12 agents

### Week 3-4 🚧
- AllocLibria integration
- GraphLibria integration
- Expand to 20 agents
- Advanced workflows

### Week 5-6 🎯
- DualLibria integration
- EvoLibria integration
- Expand to 40+ agents
...
| [atlas-core/README.md](atlas-core/README.md) | You want complete documentation |
| [INTEGRATION_CHECKLIST.md](INTEGRATION_CHECKLIST.md) | You're integrating with Libria |
| [atlas-core/AGENT_EXPANSION_GUIDE.md](atlas-core/AGENT_EXPANSION_GUIDE.md) | You're adding more agents |
...
- **Week 1 Implementation**: Claude Instance 2 (ATLAS)
...
- **Complete guide**: [atlas-core/README.md](atlas-core/README.md)
- **FAQ**: [FAQ.md](FAQ.md)
- **Troubleshooting**: Troubleshooting sections in docs

### Code Examples
- **Basic usage**: [demo.py](atlas-core/demo.py)
- **Test examples**: [tests/](atlas-core/tests/)
- **Agent examples**: [atlas_core/agents.py](atlas-core/atlas_core/agents.py)
...
**Base Directory**: `/mnt/c/Users/mesha/Downloads/Important/ATLAS/`

**Main Package**: `atlas-core/`

**Documentation**: Root directory and `atlas-core/`
