...
try:
    ...
    logger.error("Make sure you're running from the atlas-core directory")
    sys.exit(1)
...
def demo_ultrathink_agents():
    ...
    tasks = [
        ...
        AgentTask(
            ...
            metadata={"solver": {"name": "QAPLibria"}},
        ),
        AgentTask(
            task_id="infra_001",
...
def demo_full_orchestration():
    ...
    result = orchestrator.orchestrate(
        ...
        use_mezan=True,
        use_ultrathink=True,
        use_atlas=False,  # ATLAS requires Redis
    )
...
def main():
    ...
    try:
        ...
        print("  - Integrate with production ATLAS agents")
