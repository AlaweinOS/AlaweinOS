"""
ATLAS Integration with MEZAN Libria Suite

This module integrates MEZAN optimization solvers with ATLAS research orchestration,
replacing simple heuristics with optimal agent assignment.

Key integrations:
1. Agent-Task Assignment (QAPLibria)
2. Workflow Routing (FlowLibria)
3. Resource Allocation (AllocLibria)
"""
...
class ATLASOptimizationManager:
    """
    Manages optimization for ATLAS workflows

    This class provides high-level methods for ATLAS to use MEZAN solvers
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info("ATLAS Optimization Manager initialized")
    ...
    def optimize_agent_assignment(
        ...
        Uses QAPLibria to find optimal assignment considering agent synergies.
        ...
        problem = OptimizationProblem(
            ...
            metadata={
                "source": "ATLAS agent assignment",
                "n_agents": n_agents,
                "n_tasks": n_tasks,
            },
        )

        # Solve using factory (will use QAPLibria if enabled, heuristic fallback otherwise)
        optimizer = self.factory.create_optimizer(problem, timeout=30.0)
        result = optimizer.solve(problem)

        # Format result for ATLAS
    ...
    def optimize_workflow_routing(
        ...
        Uses FlowLibria to find path with maximum end-to-end confidence.
        ...
        problem = OptimizationProblem(
            ...
            metadata={"source": "ATLAS workflow routing"},
        )
    ...
    def optimize_resource_allocation(
        ...
        Uses AllocLibria with Thompson Sampling to learn optimal allocation.
        ...
        problem = OptimizationProblem(
            ...
            metadata={"source": "ATLAS resource allocation"},
        )
...
# Convenience function for ATLAS to use
def optimize_atlas_agent_assignment(
    ...
    """
    Convenience function for ATLAS agent assignment optimization
