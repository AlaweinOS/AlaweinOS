...
Demonstrates basic usage of the ATLAS Engine with multiple
...
def main():
    """Run ATLAS Engine demo"""

    logger.info("=" * 70)
    logger.info("ATLAS Engine Demo - Multi-Agent Research Orchestration")
    logger.info("=" * 70)

    # Initialize ATLAS Engine (without Libria for demo)
    ...
    logger.info(f"Registered {len(atlas.agents)} agents")
    ...
    assigned_agent_id = atlas.assign_task(test_task)
