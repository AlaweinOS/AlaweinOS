...
- MetaLibria clustering + Elo + UCB (implemented) for solver selection.
...
Summary
- Implemented: QAPFlow frontend/backend adapter and bench; MetaLibria selection; WorkFlow/AllocFlow frontends; orchestrator service.
