...
5. Backend Adapters
- QAPFlow uses `qaplibria_backend` as a shim to an external modular solver repository.
...
- `MetaLibria` clusters instances, maintains Elo ratings (global + per-cluster), and uses UCB to balance exploration and exploitation.
